	...
	public function testPagingLinks() {
		...
		$this->Paginator->request->params['paging'] = array(
			'Client' => array(
				...
				'defaults' => array(),
				'options' => array(
					'page' => 2, 'limit' => 2147483647, 'order' => array(), 'conditions' => array()
				),
				'paramType' => 'named'
			)
		);
 ...
 */
	public function testQuerystringUrlGeneration() {
		...
		$result = $this->Paginator->url(array('page' => '1', 'limit' => 2147483647, 'something' => 'else'));
		...
		$result = $this->Paginator->url(array('page' => '4', 'limit' => 2147483647, 'something' => 'else'));
