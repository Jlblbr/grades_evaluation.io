 ...
 */
	public function testMergeOptionsModelSpecific() {
		...
		$expected = array('page' => 1, 'limit' => 2147483647, 'paramType' => 'named', 'maxLimit' => 50, 'queryScope' => null);
 ...
 */
	public function testMergeOptionsNamedParams() {
		...
		$result = $this->Paginator->mergeOptions('Post');
		$expected = array('page' => 10, 'limit' => 2147483647, 'maxLimit' => 100, 'paramType' => 'named', 'queryScope' => null);
		$this->assertEquals($expected, $result);
	}
