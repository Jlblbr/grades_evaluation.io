...
$staff = isset($userData['Staff'])? $userData['Staff']: '';
?>
<!--Content-->
							...
							<div class="card-content collapse show">
								<div class="card-body">
									...
									?>
										<div class="form-body">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input 
															...
															value="<?php echo isset($staff['date_of_birth']) && $staff['date_of_birth']? $staff['date_of_birth']: ""; ?>"
														>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														...
														>
															<option 
																value="none" 
																disabled=""
																<?php echo !$staff['sex']? "selected": ""; ?>
															>Select Sex</option>
															<option 
																value="Male"
																<?php echo isset($staff['sex']) && $staff['sex']=="Male"? "selected": ""; ?>
															>Male</option>
															<option 
																value="Female"
																<?php echo isset($staff['sex']) && $staff['sex']=="Female"? "selected": ""; ?>
															>Female</option>
														</select>
													</div>
												</div>
											...
											<div class="form-group">
												...
												<textarea 
													...
													placeholder="Address"
												><?php echo isset($staff['address']) && $staff['address']? $staff['address']: ""; ?></textarea>
											</div>
										...
										<input 
											type="hidden" 
											name="data[User][staffID]" 
											value="<?php echo isset($staff['id']) && $staff['id']? $staff['id']: ""; ?>"
										>
										<input 
											type="hidden" 
											name="data[User][id]" 
