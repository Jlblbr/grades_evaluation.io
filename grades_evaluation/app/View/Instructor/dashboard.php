...
<div class="app-content content">
	<div class="content-wrapper">
		...
		<div class="content-body">
			...
			<div class="row">
				<div class="col-lg-4 col-md-12 pointer" id="student-list">
					<div class="card pull-up">
	                    <div class="card-header">
	                        <h4 class="card-title float-left">Student</h4>
				...
				<div class="col-md-12 col-lg-4 pointer" id="instructor-list">
					<div class="card pull-up">
	                    <div class="card-header">
	                        <h4 class="card-title float-left">Instructor</h4>
							<a class="heading-elements-toggle">
								<i class="la la-ellipsis-v font-medium-3"></i>
							</a>
	                    </div>
				...
				<div class="col-md-12 col-lg-4 pointer" id="staff-list">
					<div class="card pull-up">
	                    <div class="card-header">
	                        <h4 class="card-title float-left">Staff</h4>
							<a class="heading-elements-toggle">
								<i class="la la-ellipsis-v font-medium-3"></i>
							</a>
	                    </div>
...
<script type="text/javascript">
	$('#student-list').on('click', function(){
		window.location.href = "<?php echo $this->Html->url(array('controller' => 'admin', 'action' => 'studentList')); ?>";
	});
	
	$('#instructor-list').on('click', function(){
		window.location.href = "<?php echo $this->Html->url(array('controller' => 'admin', 'action' => 'instructorList')); ?>";
	});
	
	$('#staff-list').on('click', function(){
		window.location.href = "<?php echo $this->Html->url(array('controller' => 'admin', 'action' => 'staffList')); ?>";
	});
</script>