...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['academic_excellence2']) && $interviewScore['InterviewScore']['academic_excellence2'] > 0
        ? $interviewScore['InterviewScore']['academic_excellence2']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="academic_excellence2" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreAcademicExcellence2_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('input[name="academic_excellence2"]').click(function () {
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['intellectual_curiosity2']) && $interviewScore['InterviewScore']['intellectual_curiosity2'] > 0
        ? $interviewScore['InterviewScore']['intellectual_curiosity2']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="intellectual_curiosity2" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreIntellectualCuriosity2_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="intellectual_curiosity2"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['communication_skills2']) && $interviewScore['InterviewScore']['communication_skills2'] > 0
        ? $interviewScore['InterviewScore']['communication_skills2']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="communication_skills2" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreCommunicationSkills2_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="communication_skills2"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['leadership_and_service2']) && $interviewScore['InterviewScore']['leadership_and_service2'] > 0
        ? $interviewScore['InterviewScore']['leadership_and_service2']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="leadership_and_service2" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreLeadershipAndService2_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="leadership_and_service2"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['overall_impression2']) && $interviewScore['InterviewScore']['overall_impression2'] > 0
        ? $interviewScore['InterviewScore']['overall_impression2']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="overall_impression2" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreOverallImpression2_' . $i . '">' . $i . '</label>' ;
        echo '</div>';
    }
    ?>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="overall_impression2"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
