...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['academic_excellence']) && $interviewScore['InterviewScore']['academic_excellence'] > 0
        ? $interviewScore['InterviewScore']['academic_excellence']
        : '';
    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="academic_excellence" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreAcademicExcellence' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('input[name="academic_excellence"]').click(function () {
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['intellectual_curiosity']) && $interviewScore['InterviewScore']['intellectual_curiosity'] > 0
        ? $interviewScore['InterviewScore']['intellectual_curiosity']
        : '';
    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="intellectual_curiosity" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreIntellectualCuriosity' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="intellectual_curiosity"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['communication_skills']) && $interviewScore['InterviewScore']['communication_skills'] > 0
        ? $interviewScore['InterviewScore']['communication_skills']
        : '';
    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="communication_skills" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreCommunicationSkills' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="communication_skills"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['leadership_and_service']) && $interviewScore['InterviewScore']['leadership_and_service'] > 0
        ? $interviewScore['InterviewScore']['leadership_and_service']
        : '';
    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="leadership_and_service" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreLeadershipAndService' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="leadership_and_service"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['overall_impression']) && $interviewScore['InterviewScore']['overall_impression'] > 0
        ? $interviewScore['InterviewScore']['overall_impression']
        : '';
    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="overall_impression" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreOverallImpression' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="overall_impression"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>																		
