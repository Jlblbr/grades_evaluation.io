...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['academic_excellence3']) && $interviewScore['InterviewScore']['academic_excellence3'] > 0
        ? $interviewScore['InterviewScore']['academic_excellence3']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="academic_excellence3" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreAcademicExcellence3_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('input[name="academic_excellence3"]').click(function () {
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['intellectual_curiosity3']) && $interviewScore['InterviewScore']['intellectual_curiosity3'] > 0
        ? $interviewScore['InterviewScore']['intellectual_curiosity3']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="intellectual_curiosity3" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreIntellectualCuriosity3_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="intellectual_curiosity3"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['communication_skills3']) && $interviewScore['InterviewScore']['communication_skills3'] > 0
        ? $interviewScore['InterviewScore']['communication_skills3']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="communication_skills3" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreCommunicationSkills3_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="communication_skills3"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['leadership_and_service3']) && $interviewScore['InterviewScore']['leadership_and_service3'] > 0
        ? $interviewScore['InterviewScore']['leadership_and_service3']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="leadership_and_service3" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreLeadershipAndService3_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="leadership_and_service3"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['overall_impression3']) && $interviewScore['InterviewScore']['overall_impression3'] > 0
        ? $interviewScore['InterviewScore']['overall_impression3']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="overall_impression3" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreOverallImpression3_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="overall_impression3"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
