...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['academic_excellence4']) && $interviewScore['InterviewScore']['academic_excellence4'] > 0
        ? $interviewScore['InterviewScore']['academic_excellence4']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="academic_excellence4" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreAcademicExcellence4_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('input[name="academic_excellence4"]').click(function () {
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['intellectual_curiosity4']) && $interviewScore['InterviewScore']['intellectual_curiosity4'] > 0
        ? $interviewScore['InterviewScore']['intellectual_curiosity4']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="intellectual_curiosity4" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreIntellectualCuriosity4_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="intellectual_curiosity4"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['communication_skills4']) && $interviewScore['InterviewScore']['communication_skills4'] > 0
        ? $interviewScore['InterviewScore']['communication_skills4']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="communication_skills4" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreCommunicationSkills4_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="communication_skills4"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['leadership_and_service4']) && $interviewScore['InterviewScore']['leadership_and_service4'] > 0
        ? $interviewScore['InterviewScore']['leadership_and_service4']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="leadership_and_service4" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreLeadershipService4_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
</div>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="leadership_and_service4"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
...
<div class="form-group" style="display: flex; gap: 10px;">
    <?php
    $scoreValue = isset($interviewScore['InterviewScore']['overall_impression4']) && $interviewScore['InterviewScore']['overall_impression4'] > 0
        ? $interviewScore['InterviewScore']['overall_impression4']
        : '';

    for ($i = 1; $i <= 5; $i++) {
        $isChecked = ($scoreValue == $i) ? 'checked' : '';
        echo '<div class="form-check">';
        echo '<input type="checkbox" class="form-check-input form-check-input-large" name="overall_impression4" value="' . $i . '" ' . $isChecked . '>';
        echo '<label class="form-check-label form-check-label-large" for="scoreOverallImpression4_' . $i . '">' . $i . '</label>';
        echo '</div>';
    }
    ?>
...
<script>
    $(document).ready(function () {
        // Ensure only one checkbox is checked at a time
        $('input[name="overall_impression4"]').click(function () {
            $('input[name="' + $(this).attr('name') + '"]').not(this).prop('checked', false);
        });
    });
</script>
