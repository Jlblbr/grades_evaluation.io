									...
									<table class="table">
										...
										<?php foreach ($data as $record): ?>
											...
											>
												...
												<td><?php echo $record['Student']['school_id']; ?></td>
												<td><?php echo $record['Student']['sex']; ?></td>
												<td>
													<?php if (!empty($record['Student']['profile_image_name'])): ?>
														<img src="<?php echo $this->Html->url('/path_to_profile_images/' . $record['Student']['profile_image_name']); ?>" alt="Profile Image" class="img-thumbnail">
													<?php endif; ?>
												</td>
												<td><?php echo $record['Student']['address']; ?></td>
											</tr>
