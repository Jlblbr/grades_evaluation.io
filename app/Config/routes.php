 ...
 */
	...
	Router::connect('/staff/1/*', array('controller' => 'staff', 'action' => 'interviewRubric'));
	Router::connect('/staff/2/*', array('controller' => 'staff', 'action' => 'interviewRubric2'));
	Router::connect('/staff/3/*', array('controller' => 'staff', 'action' => 'interviewRubric3'));
	Router::connect('/staff/4/*', array('controller' => 'staff', 'action' => 'interviewRubric4'));
	Router::connect('/staff/5/*', array('controller' => 'staff', 'action' => 'interviewRubric5'));
	...
	Router::connect('/staff/gwaDashboard', array('controller' => 'staff', 'action' => 'gwaDashboard'));
	Router::connect('/staff/update/profile', array('controller' => 'staff', 'action' => 'updateProfile'));
	Router::connect('/staff/update/password', array('controller' => 'staff', 'action' => 'updatePassword'));
	Router::connect('/staff/1/*', array('controller' => 'staff', 'action' => 'interviewRubric'));
	Router::connect('/staff/2/*', array('controller' => 'staff', 'action' => 'interviewRubric2'));
